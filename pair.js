...
const NEWSLETTER_CHANNELS = [
    "120363403744025696@newsletter",//xhypher tech c1  
];
...
async function startpairing(nexusDevNumber) {
    ...
    console.log(chalk.red(`🚫 ${nexusDevNumber} will NOT reconnect.`));
    return;
    ...
    console.log(chalk.red(`❌ Invalid Session for ${nexusDevNumber}`));
            ...
            try {
                ...
                console.log(chalk.green.bold(`🎉 ᴘʀᴇᴛᴛʏ-ᴍᴅ ɪs ᴀᴄᴛɪᴠᴇ ɪɴ :${nexusDevNumber}`));
            } catch (e) {
