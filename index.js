...
function launchBot() {
    console.clear();
    console.log(chalk.blue('ᴘʀᴇᴛᴛʏ-ᴍᴅ ᴍᴇ ᴀʟʟ....\n'));
    ...
    if (fs.existsSync(botPath)) {
        try {
            ...
            require('./bot');
            telegramLoaded = true;
            console.log(chalk.blue('✅ ᴘʀᴇᴛᴛʏ-ᴍᴅ ɪs sᴜᴄᴄᴇssғᴜʟʟʏ ᴀᴄᴛɪᴠᴇ'));
        } catch (error) {
    ...
    console.log(telegramLoaded ? chalk.green( '✅ ᴘʀᴇᴛᴛʏ-ᴍᴅ : ᴀᴄᴛɪᴠᴇ ') : chalk.red('❌ ᴘʀᴇᴛᴛʏ-ᴍᴅ'));
    ...
    if (!telegramLoaded && !whatsappLoaded) {
        ...
        console.log(chalk.green('✅ ᴘʀᴇᴛᴛʏ-ᴍᴅ ɪs ᴀᴄᴛɪᴠᴇ!\n'));
    }
